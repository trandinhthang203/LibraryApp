...
public class BookApiController {
	...
	@PostMapping
	public ResponseEntity<ApiResponse<Object>> create(@Valid @RequestBody BookRequest bookRequest){
		return ResponseEntity.ok(ApiResponse.success("Tao thanh cong", bookService.create(bookRequest)));
	}
	
	@PutMapping("/{id}")
	public ResponseEntity<ApiResponse<Object>> update(@PathVariable Long id, @Valid  @RequestBody BookRequest bookRequest){
		return ResponseEntity.ok(ApiResponse.success("Sua thanh cong", bookService.update(id, bookRequest)));
	}
